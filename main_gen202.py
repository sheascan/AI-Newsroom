...
# --- VERSION TRACKER ---
VERSION_ID = "Gen 202 (Robust Requests + Single-Article Fix)"
...
class ContentClusterer:
    ...
    def run_clustering(self, articles, embeddings):
        ...
        if n_articles < 2:
            ...
            # Manually construct the "clusters" map for a single item
            # We treat it as "Group_0" so it processes normally
...
# --- STAGE 1 & 2: SCRAPING (UPDATED GEN 202) ---
...
def fetch_article_text(url):
    ...
    # --- GEN 202: LEVEL 1 ROBUST REQUEST MODEL ---
    try:
        ...
        # Correct encoding if requests guessed wrong (e.g., ISO-8859-1 vs UTF-8)
        ...
        # --- FIX: SANITIZE HTML ---
        # Strip null bytes and control characters that crash lxml/newspaper
        if html_content:
        ...
        if not article.text or len(article.text) < 100:
             log_failure(url, "Parsing Failed (Content Extraction)")
             STATS["scraped_failed"] += 1
             return None
