...
def sync_folders():
    ...
    print(f"🔄 Syncing from {LOCAL_OUTPUT_DIR} -> {DROPBOX_LOCAL_DIR}")
    ...
    for day_folder in os.listdir(LOCAL_OUTPUT_DIR):
        ...
        if os.path.isdir(src_path):
            ...
            if not os.path.exists(dst_path):
                ...
                print(f"   ✅ Copied new day: {day_folder}")
            else:
