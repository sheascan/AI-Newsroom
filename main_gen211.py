...
# --- VERSION TRACKER ---
VERSION_ID = "Gen 211 (Verified Model: gemini-embedding-001)"
...
# UPDATED: We now use the model proven to work by your test
...
def get_embeddings_batch(texts):
    ...
    try:
        ...
        print(f"      ❌ Embedding Error ({EMBEDDING_MODEL}): {e}")
        return None
