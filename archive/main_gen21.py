...
BATCH_SIZE = 10     
SLEEP_TIME = 20     # Increased to 20s for maximum stability
...
# --- STAGE 3: THE EDITOR (GEN 21: ZEN MODE) ---
def ai_cluster_and_summarize(article_objects):
    ...
    for i in range(0, len(ids), BATCH_SIZE):
        ...
        # 20s Sleep for Zen Mode
        time.sleep(SLEEP_TIME)

    print("   🧘 Phase A Complete. Cooling down for 60s before Phase B...")
    time.sleep(60)
