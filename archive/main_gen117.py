...
# --- VERSION TRACKER ---
VERSION_ID = "Gen 117 (Model Fix: 2.0 Flash Exp)"
...
CHECKPOINT_FILE = os.path.join(CACHE_DIR, "gen117_clusters.json")
...
# We prioritize the experimental 2.0 Flash model which is usually globally available
        ...
        try:
            ...
            if "429" in e_str or "resource_exhausted" in e_str:
                ...
                if model_name != "gemini-1.5-pro":
                    return generate_with_retry("gemini-1.5-pro", contents, config, retries-1)
                else:
                    return None
            else:
