...
# MODEL CONFIGURATION
# Using 2.0-flash-lite based on your available models list.
# This model is optimized for cost/latency and should avoid the 20-request cap.
MODEL_NAME = "gemini-2.0-flash-lite"
BATCH_SIZE = 30     # Back to efficient batching
SLEEP_TIME = 5      # Standard safety pause
...
# --- STAGE 3: THE EDITOR (GEN 18: FLASH LITE EDITION) ---
