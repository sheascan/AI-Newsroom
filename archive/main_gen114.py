...
# --- VERSION TRACKER ---
VERSION_ID = "Gen 114 (Auto-Model Discovery)"
...
CHECKPOINT_FILE = os.path.join(CACHE_DIR, "gen114_clusters.json")
...
def get_best_model(client_obj):
    ...
    try:
        ...
        # Note: In the new SDK, this returns an iterable of Model objects
        all_models = list(client_obj.models.list())
        
        # 2. Extract clean names (removing 'models/' prefix if present)
        available_names = []
        for m in all_models:
