...
# Using 1.5-flash which has 1,500 RPD limit, unlike the typo version.
...
def generate_with_retry(model_name, contents, config, retries=5):
    """Wraps Gemini calls with Backoff."""
    base_wait = 10 
...
# --- STAGE 3: THE EDITOR (GEN 16: CORRECT MODEL NAME) ---
def ai_cluster_and_summarize(article_objects):
    ...
    batch_size = 25 # Safe size for 1.5-Flash
    ...
    for i in range(0, len(ids), batch_size):
        ...
        # 5s sleep is enough for 1.5-Flash
        time.sleep(5)
