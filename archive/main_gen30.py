...
# --- VERSION TRACKER ---
VERSION_ID = "Gen 30 (The Diagnostic: Key Verifier)"
...
# MODEL CONFIGURATION
# Set to the model you CONFIRMED has 0 usage in the new account
    ...
    for attempt in range(retries):
        try:
            ...
            if "429" in error_str or "RESOURCE_EXHAUSTED" in error_str:
                ...
                # DIAGNOSTIC PRINT FOR 429
                print(f"      ⚠️  Quota Hit (429). Attempt {attempt+1}/{retries}")
                if attempt == 0: # Only print deep details once
                    print(f"      🔎  Diagnostic: {error_str[:200]}...") # Print first 200 chars of error
