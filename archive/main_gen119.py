...
# --- VERSION TRACKER ---
VERSION_ID = "Gen 119 (High Visibility Debug)"
...
# --- MODEL SELECTION ---
# Primary: 8b (Fastest). Fallback: 1.5 Flash (Standard)
        ...
        try:
            ...
            if "429" in e_str or "resource_exhausted" in e_str:
                ...
                if model_name != "gemini-2.5-flash":
                    print(f"         ➡️ Falling back to gemini-2.5-flash...")
...
def ai_cluster_and_summarize(article_objects):
    ...
    for tag, arts in raw_clusters.items():
        ...
        # SKIP NAMING API CALL (Use 1st headline)
