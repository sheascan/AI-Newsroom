...
# --- STAGE 3: THE EDITOR (GEN 14: CONSERVATIVE BATCHING) ---
def ai_cluster_and_summarize(article_objects):
    ...
    # --- PHASE A: THE SORTER (SMALLER BATCHES) ---
    print("   -> Phase A: Sorting into broad themes (Conservative Batch Mode)...")
    
    master_buckets = {}
    
    # REDUCED BATCH SIZE TO 20 (Was 40)
