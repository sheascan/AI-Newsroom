...
# --- STAGE 3: THE EDITOR (GEN 12: SMALLER BATCHES) ---
def ai_cluster_and_summarize(article_objects):
    ...
    if response and response.text:
        ...
        # Reduced Chunk Size from 50 to 25 to allow Token Bucket recovery
        for i in range(0, len(ids), 25): sorted_buckets[f"Batch_{i}"] = ids[i:i+25]
