...
# --- VERSION TRACKER ---
VERSION_ID = "Gen 110 (Stable Flash 1.5)"
...
CHECKPOINT_FILE = os.path.join(CACHE_DIR, "gen110_clusters.json")
...
# We use 'gemini-1.5-flash' because it typically allows 1,500 requests/day.
# The '2.5-flash-lite' model in your screenshot is limited to 20/day.
...
# --- STAGE 2: SCRAPER (STEALTH LAWNMOWER) ---
def clean_text(text):
    if not text: return ""
...
def fetch_article_text(url):
    ...
    # Throttling to prevent IP bans (improves scrape success)
    time.sleep(random.uniform(0.5, 2.0))

    try:
        # --- STEALTH MODE: User Agent to bypass bot blockers ---
        conf = Config()
        ...
        # --- LAWNMOWER MODE: Hard limit at 1000 chars ---
