...
# --- STAGE 3: THE EDITOR (GEN 15: MICRO-BATCHING) ---
def ai_cluster_and_summarize(article_objects):
    ...
    print("   -> Phase A: Sorting into broad themes (Micro-Batch Mode)...")
    ...
    for i in range(0, len(ids), batch_size):
        ...
        # MANDATORY 15s COOL DOWN to recharge Free Tier Token Bucket
        time.sleep(15)
