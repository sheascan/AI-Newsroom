...
# --- VERSION TRACKER ---
VERSION_ID = "Gen 207 (Embedding Fallback)"
...
# --- HELPER: EMBEDDINGS (BATCHED & ROBUST) ---
def get_embeddings_batch(texts):
    ...
    try:
        ...
        print(f"      ⚠️ Primary Embedding ({EMBEDDING_MODEL_PRIMARY}) Failed: {e}")
        print(f"      🔄 Switching to Fallback ({EMBEDDING_MODEL_FALLBACK})...")
